   ...
   return (
         <div className="flex justify-between items-center mt-11 mx-10 lg:mx-20">
          <div className="relative">
            <input type="text" placeholder="Search" className="h-9 w-80 rounded-full bg-white h-8 px-4 py-2 outline-none text-dark placeholder-grey::placeholder text-base shadow-md" />
