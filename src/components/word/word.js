...
const Word = () => {
   ...
   return (
      <div className="wordWrapper">
         <div className={isSelected ? "word--selected" : "word"} onClick={(e) => selectWord(e)}>
         <div className="cursor-pointer absolute top-3 right-1" onClick={(e) => openMoreAction(e)}><MoreVertIcon className={isSelected ? "moreActionBtn--open-Active" : "moreActionBtn--open"} /></div>
         <div>
            <div className="flex items-center">
               <div className="h-2 w-2 bg-green rounded-full"></div>
               <div className={isSelected ? "text-white text-lg ml-2" : "text-black text-lg ml-2"}>facilitate</div>
            </div>
            <div className={isSelected ? "text-lightPurple" : "text-textDarkGray"}>
               <div className="text-base ml-4 font-light">сприяти</div>
            </div>
         </div>

         <div className={isSelected ? "text-lightPurple" : "text-textDarkGray"}>
            <div className="text-sm italic font-light">Synonyms</div>
            <hr className={isSelected ? "border-t-1 border-purpleMedium mt-1" : "border-t-1 border-lightGray mt-1"} />
            <div className="flex font-light mt-1 flex-wrap text-sm">
               <div className="">easy, &nbsp;</div>
               <div className="">lighten, &nbsp;</div>
               <div className="">relieve
               &nbsp;</div>
            </div>
         </div>
         </div>
         ...
         { moreAction
            ?
            <div className={isSelected ? "moreActionWord text-white" : "moreActionWord text-darkGray"} ref={moreActionMenu}>
               <div className="absolute top-3 right-2 cursor-pointer" onClick={(e) => closeMoreAction(e)}><CloseRoundedIcon/></div>
                  <div className={isSelected ? "flex w-max items-center cursor-pointer" : "flex w-max items-center moreAction__btnAdd cursor-pointer"} >
                  ...
                  <div className= {isSelected ? "flex w-max items-center cursor-pointer" : "flex w-max items-center moreAction__btnFix cursor-pointer"}>
                  ...
                  <div className={isSelected ? "flex w-max items-center cursor-pointer" : "flex w-max items-center moreAction__btnDelete cursor-pointer"}>
